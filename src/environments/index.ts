...
// mongodb
const MYSQL_URL: string = +process.env.MYSQL_PORT
	? `mongodb://localhost:${process.env.MYSQL_PORT}`
	: MLAB_URL
const MYSQL_PORT: number = +process.env.MYSQL_PORT || 3306
const MYSQL_DB: string = process.env.MYSQL_PORT ? 'chnirt-nest' : MLAB_DATABASE
